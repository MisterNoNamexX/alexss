...
public class PlayerMovement : MonoBehaviour
    // I'll need some movement script that has some sort of trigger object to make sure the 'coin' disappears 
    // I need to make sure that the enemy has code as well to make sure its trying to find the player
{
